$(function () {
  ...
  */
  ...
  $('#addCommentForm').submit(function() {
    $comments.activity();
    var $form = $(this),
    username = $form.find('input[name="comment[username]"]').val(),
    body= $form.find('textarea[name="comment[body]"]').val()
    ;
    $form.find('textarea[name="comment[body]"]').val(escape(body));
    $form.find('input[name="comment[username]"]').val(escape(username));
    ...
    $.ajax({
      ...
      success: function(data){
        ...
        $form.find('textarea[name="comment[body]"]').val('');
        $form.find('input[name="comment[username]"]').val('');
